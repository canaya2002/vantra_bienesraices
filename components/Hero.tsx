...
export default function Hero() {
  ...
  useEffect(() => {
    // El "Intro" dura 2.5 segundos mostrando solo el video limpio
    ...
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          poster="/images/hero-poster.jpg" // Asegúrate de tener una imagen de respaldo ligera
        >
          {/* Aquí cargamos tu nuevo video */}
          <source src="/videos/vantralanding.mp4" type="video/mp4" />
        </video>
        
        {/* Overlay Gradiente - Aparece suavemente después del intro para mejorar legibilidad del texto */}
        <motion.div 
          initial={{ opacity: 0 }}
      ...
      {/* Contenido del Hero - Aparece después del intro */}
      <AnimatePresence>
        {isIntroFinished && (
