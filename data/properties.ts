...
El área de master suite incluye vestidor amplio, baño de mármol con tina independiente y terraza privada. Las habitaciones adicionales ofrecen baño propio y closets amplios.`,
    ...
    yearBuilt: 2022,
    propertyType: 'Casa',
    features: ['Alberca climatizada', 'Cava de vinos', 'Gimnasio privado', 'Sistema domótico', 'Seguridad 24/7', 'Jardín privado', 'Terraza con vista', 'Cocina gourmet', 'Elevador privado'],
    images: [
      { id: '1-1', url: '/images/propiedades/prop_1_img_1.jpg', alt: 'Fachada principal residencia Lomas de Chapultepec', order: 1 },
...
La cocina italiana cuenta con los más finos acabados y equipo profesional. El comedor tiene capacidad para 12 personas con vistas espectaculares.`,
    ...
    features: ['Terraza panorámica 200m²', 'Jacuzzi exterior', 'Vistas 360°', 'Techos doble altura', 'Cocina italiana', 'Área de asador', 'Elevador privado', 'Domótica completa', 'Seguridad biométrica'],
    images: [
...
Los espacios interiores fluyen naturalmente hacia el exterior a través de grandes ventanales que maximizan la luz natural y las vistas panorámicas.
...
La propiedad cuenta con un amplio jardín que incluye alberca infinity edge, área de asador techada y espacios para eventos al aire libre.`,
    ...
    yearBuilt: 2021,
    propertyType: 'Casa',
    features: ['Vistas Sierra Madre', 'Alberca infinity edge', 'Paneles solares', 'Automatización total', 'Área de asador', 'Estudio independiente', 'Cuarto de pánico', 'Tratamiento de agua', 'Jardín amplio'],
    images: [
      { id: '3-1', url: '/images/propiedades/prop_3_img_1.jpg', alt: 'Fachada casa Valle Oriente Monterrey', order: 1 },
      { id: '3-2', url: '/images/propiedades/prop_3_img_2.jpg', alt: 'Sala con vista a la Sierra Madre', order: 2 },
...
El edificio ofrece: lobby con concierge, gimnasio equipado, roof garden con área social, y estacionamiento techado.`,
    ...
    features: ['Terraza arbolada', 'Pisos de madera', 'Cocina abierta', 'Gimnasio en edificio', 'Roof garden', 'Concierge 24/7', 'Iluminación arquitectónica', 'Closets vestidor', 'Cuarto de lavado'],
    images: [
      { id: '4-1', url: '/images/propiedades/prop_4_img_1.jpg', alt: 'Sala departamento Providencia Guadalajara', order: 1 },
      { id: '4-2', url: '/images/propiedades/prop_4_img_2.jpg', alt: 'Terraza con vista arbolada', order: 2 },
  ...
  },
  {
    ...
    description: `Majestuosa residencia ubicada en uno de los desarrollos más exclusivos de Carretera Nacional en Monterrey. Con más de 1,100 metros cuadrados de construcción, la casa ofrece espacios monumentales con techos de más de 6 metros de altura.
...
El área exterior es un verdadero oasis: alberca de forma orgánica, cascada, palapa con cocina exterior completa, y extensos jardines con riego automatizado.`,
    ...
    yearBuilt: 2020,
    propertyType: 'Casa',
    features: ['Cine en casa', 'Cava 500 botellas', 'Alberca con cascada', 'Palapa con cocina', 'Sala de juegos', 'Cuarto de masajes', 'Jardines extensos', 'CCTV perimetral', 'Techos 6m altura'],
    images: [
      { id: '5-1', url: '/images/propiedades/prop_5_img_1.jpg', alt: 'Vista aérea residencia Carretera Nacional', order: 1 },
      { id: '5-2', url: '/images/propiedades/prop_5_img_2.jpg', alt: 'Sala monumental doble altura', order: 2 },
      { id: '5-3', url: '/images/propiedades/prop_5_img_3.jpg', alt: 'Alberca con cascada', order: 3 },
      { id: '5-4', url: '/images/propiedades/prop_5_img_4.jpg', alt: 'Cine en casa privado', order: 4 },
      { id: '5-5', url: '/images/propiedades/prop_5_img_5.jpg', alt: 'Cava de vinos premium', order: 5 },
    ],
  ...
  {
    id: '6',
    slug: 'penthouse-puerta-de-hierro-guadalajara',
    title: 'Penthouse en Puerta de Hierro',
    description: `Sofisticado penthouse en la torre más emblemática de Puerta de Hierro, junto a Andares. El diseño interior fue realizado por un reconocido despacho de arquitectura.
...
La terraza envolvente ofrece vistas de 270 grados que incluyen el atardecer sobre la ciudad. El espacio exterior cuenta con pérgola motorizada, área lounge y jacuzzi con vista panorámica.`,
    ...
    yearBuilt: 2023,
    propertyType: 'Penthouse',
    features: ['Terraza 270°', 'Jacuzzi panorámico', 'Diseño de autor', 'Pérgola motorizada', 'Spa en edificio', 'Alberca infinity', 'Business center', 'Valet parking', 'Salón de eventos'],
    images: [
      { id: '6-1', url: '/images/propiedades/prop_6_img_1.jpg', alt: 'Living penthouse Puerta de Hierro', order: 1 },
      { id: '6-2', url: '/images/propiedades/prop_6_img_2.jpg', alt: 'Terraza con atardecer Guadalajara', order: 2 },
      { id: '6-3', url: '/images/propiedades/prop_6_img_3.jpg', alt: 'Comedor de diseñador', order: 3 },
      { id: '6-4', url: '/images/propiedades/prop_6_img_4.jpg', alt: 'Jacuzzi panorámico nocturno', order: 4 },
      { id: '6-5', url: '/images/propiedades/prop_6_img_5.jpg', alt: 'Suite principal con vestidor', order: 5 },
    ],
...
La vista desde el piso 18 ofrece un panorama impresionante del skyline de Santa Fe y los bosques que rodean la zona.`,
    ...
    yearBuilt: 2022,
    propertyType: 'Departamento',
    features: ['Vista al skyline', 'Piso 18', 'Área coworking', 'Gimnasio equipado', 'Terraza con asadores', 'Acceso a mall', 'Cocina integral', 'Portero 24/7', 'Pet friendly'],
    images: [
      { id: '7-1', url: '/images/propiedades/prop_7_img_1.jpg', alt: 'Sala departamento Santa Fe CDMX', order: 1 },
      { id: '7-2', url: '/images/propiedades/prop_7_img_2.jpg', alt: 'Vista nocturna skyline Santa Fe', order: 2 },
      { id: '7-3', url: '/images/propiedades/prop_7_img_3.jpg', alt: 'Cocina integral moderna', order: 3 },
      { id: '7-4', url: '/images/propiedades/prop_7_img_4.jpg', alt: 'Recámara con vista panorámica', order: 4 },
...
Esta propiedad de estilo californiano contemporáneo ofrece amplios espacios de convivencia que fluyen naturalmente entre interior y exterior.`,
    ...
    yearBuilt: 2019,
    propertyType: 'Casa',
    features: ['Estilo californiano', 'Jardines maduros', 'Roof garden', 'Sótano con cava', 'Área entretenimiento', 'Riego inteligente', 'Cerca de escuelas', 'Alta plusvalía', 'Privacidad total'],
    images: [
      { id: '8-1', url: '/images/propiedades/prop_8_img_1.jpg', alt: 'Fachada residencia San Pedro Garza García', order: 1 },
      { id: '8-2', url: '/images/propiedades/prop_8_img_2.jpg', alt: 'Jardín y terraza exterior', order: 2 },
      { id: '8-3', url: '/images/propiedades/prop_8_img_3.jpg', alt: 'Sala familiar amplia', order: 3 },
      { id: '8-4', url: '/images/propiedades/prop_8_img_4.jpg', alt: 'Roof garden privado', order: 4 },
      { id: '8-5', url: '/images/propiedades/prop_8_img_5.jpg', alt: 'Sótano de entretenimiento', order: 5 },
    ],
  ...
  {
    id: '9',
    slug: 'departamento-renta-condesa-cdmx',
    title: 'Departamento Amueblado en La Condesa',
    description: `Departamento completamente amueblado y equipado en el corazón de La Condesa, una de las colonias con más personalidad de Ciudad de México. Ideal para ejecutivos, diplomáticos o familias que buscan una estancia de calidad.

Ubicado a pasos del Parque México, rodeado de cafés, restaurantes y galerías. El inmueble cuenta con acabados de primera, iluminación natural excepcional y un balcón con vista al parque.`,
    shortDescription: 'Departamento amueblado de lujo en La Condesa, a pasos del Parque México. Disponible en renta.',
    price: 45000,
    priceFormatted: '$45,000 MXN/mes',
    operation: 'renta',
    city: 'Ciudad de México',
    citySlug: 'ciudad-de-mexico',
    neighborhood: 'La Condesa',
    address: 'Calle Tamaulipas 100, Condesa',
    squareMeters: 110,
    bedrooms: 2,
    bathrooms: 2,
    parkingSpaces: 1,
    yearBuilt: 2020,
    propertyType: 'Departamento',
    features: ['Amueblado completo', 'Vista al Parque México', 'Balcón privado', 'Cocina equipada', 'Internet incluido', 'Pet friendly', 'Seguridad 24/7', 'Cuarto de lavado', 'Edificio boutique'],
    images: [
      { id: '9-1', url: '/images/propiedades/prop_4_img_1.jpg', alt: 'Sala departamento amueblado Condesa', order: 1 },
      { id: '9-2', url: '/images/propiedades/prop_4_img_2.jpg', alt: 'Balcón con vista al Parque México', order: 2 },
      { id: '9-3', url: '/images/propiedades/prop_4_img_3.jpg', alt: 'Cocina equipada moderna', order: 3 },
      { id: '9-4', url: '/images/propiedades/prop_4_img_4.jpg', alt: 'Recámara principal amueblada', order: 4 },
      { id: '9-5', url: '/images/propiedades/prop_4_img_5.jpg', alt: 'Baño con acabados premium', order: 5 },
    ],
    mainImage: '/images/propiedades/prop_4_img_1.jpg',
    coordinates: { lat: 19.4117, lng: -99.1735 },
    isFeatured: true,
    isNew: true,
  ...
  {
    id: '10',
    slug: 'casa-renta-san-pedro-monterrey',
    title: 'Casa en Renta en San Pedro',
    description: `Amplia casa en renta en una de las zonas más seguras y bien comunicadas de Monterrey. Ideal para familias que buscan calidad de vida sin compromisos a largo plazo.

La propiedad cuenta con amplios jardines, alberca privada y acabados de alta calidad. Ubicada en fraccionamiento cerrado con vigilancia permanente.`,
    shortDescription: 'Casa espaciosa en renta con alberca y jardín en fraccionamiento de San Pedro, Monterrey.',
    price: 85000,
    priceFormatted: '$85,000 MXN/mes',
    operation: 'renta',
    city: 'Monterrey',
    citySlug: 'monterrey',
    neighborhood: 'San Pedro Garza García',
    address: 'Privada del Valle 300, San Pedro',
    squareMeters: 400,
    bedrooms: 4,
    bathrooms: 4,
    parkingSpaces: 3,
    yearBuilt: 2018,
    propertyType: 'Casa',
    features: ['Alberca privada', 'Jardín amplio', 'Fraccionamiento cerrado', 'Vigilancia 24/7', 'Cocina integral', 'Cuarto de servicio', 'Terraza techada', 'Área de juegos', 'Estacionamiento triple'],
    images: [
      { id: '10-1', url: '/images/propiedades/prop_3_img_1.jpg', alt: 'Fachada casa renta San Pedro Monterrey', order: 1 },
      { id: '10-2', url: '/images/propiedades/prop_3_img_2.jpg', alt: 'Jardín con alberca privada', order: 2 },
      { id: '10-3', url: '/images/propiedades/prop_3_img_3.jpg', alt: 'Sala familiar iluminada', order: 3 },
      { id: '10-4', url: '/images/propiedades/prop_3_img_4.jpg', alt: 'Cocina integral equipada', order: 4 },
      { id: '10-5', url: '/images/propiedades/prop_3_img_5.jpg', alt: 'Recámara principal', order: 5 },
    ],
    mainImage: '/images/propiedades/prop_3_img_1.jpg',
    coordinates: { lat: 25.6580, lng: -100.3700 },
    isFeatured: false,
    isNew: false,
...
export function getPropertiesByOperation(operation: 'venta' | 'renta'): Property[] {
